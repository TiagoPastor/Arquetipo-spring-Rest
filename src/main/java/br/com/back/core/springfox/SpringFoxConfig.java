package br.com.back.core.springfox;
...
import br.com.back.api.openapi.model.GroupsModelOpenApi;
import br.com.back.api.openapi.model.LinksModelOpenApi;
import br.com.back.api.openapi.model.PageableModelOpenApi;
import br.com.back.api.openapi.model.PermissionsModelOpenApi;
import br.com.back.api.openapi.model.UsersModelOpenApi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					.apis(RequestHandlerSelectors.basePackage("br.com.myapk.api"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Arquétipo API Restful")
				.description("Arquetipo API Restful")
				.version("1")
				.contact(new Contact("MyApk", "https://www.myapk.com.br", "contato@myapk.com.br"))
				.build();
	}
